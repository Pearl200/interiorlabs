...
const Mainpage = () => {
  return (
    <div className="flex flex-col justify-end relative h-full w-full">
      <div className="grid grid-cols-4 h-[45vh] md:justify-stretch">
        <img
          src="/assets/family.jpg"
          alt="Family"
          className="w-[40vw] h-[45vh] col-span-2"
        />
        <div className="bg-white flex flex-col justify-around h-[45vh] md:justify-stretch">
          ...
          <span className="px-4 text-[10px]">
            ...
            need. The relationship between form and function is at the heart of
            our philosophy.
          </span>
